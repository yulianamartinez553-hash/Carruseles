...
.h-title{
  font-family:var(--pop);font-weight:800;font-size:54px;line-height:1.05;
...
.h-title .num{color:var(--verde);font-size:72px;line-height:.9;flex:0 0 auto;}
...
.fable-name{font-family:var(--pop);font-weight:800;font-size:34px;color:#F2F2F2;letter-spacing:2px;}
.cover-title{
  margin-top:40px;font-family:var(--pop);font-weight:800;font-size:78px;line-height:.98;
...
.value-box{
  ...
  font-family:var(--pop);font-weight:800;font-size:36px;color:#F2F2F2;letter-spacing:.5px;
}
...
.cta-line{margin-top:18px;font-family:var(--pop);font-weight:800;font-size:72px;color:#0A0A0A;line-height:1;}
.cta-kw{
  margin-top:6px;font-family:var(--pop);font-weight:800;font-size:120px;line-height:.95;
...
|---|---|---|---|---|
| Poppins | 800 ExtraBold | títulos (portada/CTA más gruesos) | `fonts/Poppins-ExtraBold.ttf` | `@font-face` base64 en HTML |
| Poppins | 700 Bold | énfasis secundario | `fonts/Poppins-Bold.ttf` | `@font-face` base64 |
