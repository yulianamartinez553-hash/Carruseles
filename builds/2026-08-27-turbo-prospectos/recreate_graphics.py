...
SPECS: dict[int, tuple[tuple[int, int], list, list]] = {
    ...
    8: (
        (1158, 630),
        [(0, 0, 200, 140), (115, 0, 300, 95), (400, 0, 280, 70), (685, 0, 280, 95),
         (0, 140, 1158, 40), (48, 185, 300, 110), (350, 185, 280, 50),
         (678, 175, 300, 110), (325, 250, 330, 55), (200, 320, 400, 40),
         (325, 360, 310, 120), (650, 360, 300, 90), (735, 400, 250, 90),
         (0, 500, 1158, 130), (900, 500, 258, 130)],
        [L(0, 0, 180, 125, lines=["Corré.", "Aprendé.", "Evolucioná.", "24/7."], size=14),
         ...
         L(735, 405, 210, 72, lines=["24/7", "TURBO"], size=14, color=V, align="center")],
    ),
}
