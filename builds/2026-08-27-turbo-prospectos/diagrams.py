...
<div class="dia dia-03">
  ...
  <div class="dia-tag">DATOS → ANÁLISIS → MEJORA</div>
</div>"""
...
def diagram_06() -> str:
    ...
    imp = ["INSTRUCCIÓN ACTUALIZADA", "REGLAS REFINADAS", "MEMORIA EXPANDIDA", "FLUJO OPTIMIZADO", "HERRAMIENTAS MEJORADAS"]
...
<div class="dia dia-07">
  ...
  <div class="dia-vs"><div class="vs-ring">↔</div></div>
