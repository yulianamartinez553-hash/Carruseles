...
.obj-monitor{{
  position:absolute;left:820px;top:340px;width:920px;height:920px;z-index:12;
  filter:drop-shadow(0 50px 80px rgba(0,0,0,.75));opacity:.92;
}}
.obj-monitor img{{width:100%;height:100%;object-fit:contain;object-position:center;}}
...
.s1-box .body{{margin-top:28px;font-size:36px;max-width:780px;}}
.s1-scrim{{
  position:absolute;left:0;right:0;top:0;height:620px;z-index:15;pointer-events:none;
  background:linear-gradient(180deg, rgba(7,7,7,.72) 0%, rgba(7,7,7,.35) 55%, transparent 100%);
}}

/* Slide 2 */
.s2-box{{position:absolute;left:72px;right:72px;top:100px;z-index:21;}}
.s2-box .h-pop{{font-size:64px;max-width:900px;}}
.s2-box .body{{margin-top:26px;font-size:35px;max-width:820px;}}
.s2-box .body + .body{{margin-top:18px;}}
.claude-row{{
...
.s2-scrim{{
  position:absolute;left:0;right:42%;top:0;bottom:140px;z-index:15;pointer-events:none;
  background:linear-gradient(90deg, rgba(7,7,7,.78) 0%, rgba(7,7,7,.45) 70%, transparent 100%);
}}
